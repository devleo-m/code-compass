...
// 3. Componente
export function ModuleList({ modules, pathId, className = '' }: ModuleListProps) {
    // 4. Lógica
    ...
    return (
        <div className={`space-y-6 ${className}`}>
            <h2 className='text-2xl font-bold text-gray-900 mb-6'>Módulos da Trilha</h2>
                            ...
                            <div className='flex-1'>
                                ...
                                <div className='flex items-center space-x-3 mb-3'>
                                    <div className='w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center'>
                                        <span className='text-blue-600 font-semibold text-sm'>{module.order}</span>
                                    </div>
                                    <div>
                                ...
                                <div className='flex items-center space-x-6 mb-4'>
                                    <div className='flex items-center space-x-2'>
                                        ...
                                        <span className='text-sm text-gray-600'>{module.lessons.length} lições</span>
                                    </div>
...
export function ModuleCard({ module, pathId }: { module: Module; pathId: string }) {
    return (
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center space-x-3'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-gray-600'>{module.lessons.length} lições</p>
                    </div>
                </div>
