                ...
                <div className='min-h-screen flex items-center justify-center bg-gray-50 px-4'>
                    <div className='max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center'>
                        ...
                        <p className='text-gray-600 mb-6'>
                            Encontramos um problema inesperado. Tente recarregar a página ou entre em contato conosco se
                        ...
                        <div className='flex flex-col sm:flex-row gap-3 justify-center'>
                            <Button variant='primary' onClick={this.handleReset} className='flex-1 sm:flex-none'>
                                Tentar Novamente
                            </Button>
                        ...
                        <div className='mt-6 pt-6 border-t border-gray-200'>
                            <p className='text-sm text-gray-500'>
                                Precisa de ajuda?{' '}
                                <a href='/contato' className='text-blue-600 hover:text-blue-800 font-medium'>
                                    Entre em contato
                                </a>
                            </p>
                        </div>
        ...
        <div className='p-4 bg-red-50 border border-red-200 rounded-lg'>
            <div className='flex items-center space-x-3'>
                ...
                <div className='flex-1'>
                    <h3 className='text-sm font-medium text-red-800'>Erro: {error.message}</h3>
                </div>
